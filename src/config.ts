...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: true,
		src: "assets/images/P1070274.JPG", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/avatar_2.png", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
	name: "Thợ Dev",
